...
int compile_calculate(int a, int b, int n, int t, int c) {
  FILE *file;
  ...
  command[0] = '\0';
  // Format command
  snprintf(command, 128, "./%s %i %i %i %i %i", path_function_script, a, b, n, t, c);
